<?php   
    ...
    if($password === $password_confirm){// Это проверка на правильность пароля 
        ...
        mysqli_query($connect,"CREATE TABLE `$company_name`.`history`(`id` INT UNSIGNED NOT NULL AUTO_INCREMENT , `data_time` VARCHAR(255) NOT NULL , `user` VARCHAR(255) NOT NULL , `change_name` VARCHAR(255) NOT NULL , `changed_info` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
